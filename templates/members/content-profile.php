...
$avatar = get_field('profile_avatar', 'user_'.$user->ID);
        ...
        <div class="row">
            <div class="profile-wrapper">
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <img class="profile-avatar" src="<?php echo $avatar; ?>" width="100%" alt="avatar">
                    <form id="featured_upload" method="post" action="/user/profile/" enctype="multipart/form-data" role="form">
                        <div class="form-group">
                            <input type="file" class="form-control" name="my_image_upload" id="my_image_upload" multiple="false" placeholder="<?php _e('Upload your avatar...', 'vifonic'); ?>" >
                            <input type="hidden" name="post_id" id="post_id" value="0" />
	                        <?php wp_nonce_field( 'my_image_upload', 'my_image_upload_nonce' ); ?>
                        </div>
                        <div class="btn-group">
                            <button type="submit" id="submit_my_image_upload" name="submit_my_image_upload" class="btn btn-primary"><?php _e('Upload', 'vifonic'); ?></button>
                        </div>
                    </form>
                </div>
                            ...
                            <div class="modal-content">
                                <form id="update-profile-form" action="/user/profile/update-profile" method="post" role="form">
                                    ...
                                    <div class="modal-body">
                                        <!--<div class="form-group">
                                            <label for="vifonic_avatar"><?php /*_e('Avatar Url', 'vifonic'); */?></label><br>
                                            <img class="profile-avatar" src="<?php /*echo $avatar; */?>" width="100" alt="avatar">
                                            <input type="text" class="form-control" name="vifonic_avatar" id="vifonic_avatar" placeholder="<?php /*_e('Avatar Url', 'vifonic'); */?>" value="<?php /*echo $avatar; */?>">
                                        </div>-->
                                        <div class="form-group">
